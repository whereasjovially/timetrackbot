...
import model.working_hours_mongo_manager as working_hours_manager

class WorkingHoursModel(object):
    '''
    This Taskmodel is a wrapper which calls the middleware API
    '''

    def __init__(self, manager: working_hours_manager.WorkingHoursMongoManager):
        '''
        Constructor
        '''
        # Mgmt
